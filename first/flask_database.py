...
class FlaskDataBase:
    ...
    def add_user(self, name, email, hash):
        try:
            ...
            if result['count'] > 0:
                print("A user with such an email is already registered")
                return False
    ...
    def get_user(self, user_id):
        try:
            ...
            print(f"Exception in getting user by id {user_id}: {e}")
        return False, False
    ...
    def get_user_by_email(self, email):
        try:
            ...
            print(f"Exception in getting user by email {email}: {e}")
        return False, False
